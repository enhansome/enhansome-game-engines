...
[![GitHub forks](https://badgen.net/github/forks/ChessMax/awesome-game-engines/)](https://GitHub.com/ChessMax/awesome-game-engines/network/) ⭐ 132 | 🐛 1 | 🌐 Markdown | 📅 2026-08-21
[![GitHub stars](https://badgen.net/github/stars/ChessMax/awesome-game-engines)](https://GitHub.com/ChessMax/awesome-game-engines/stargazers/) ⭐ 132 | 🐛 1 | 🌐 Markdown | 📅 2026-08-21
[![GitHub contributors](https://badgen.net/github/contributors/ChessMax/awesome-game-engines)](https://GitHub.com/ChessMax/awesome-game-engines/graphs/contributors/) ⭐ 132 | 🐛 1 | 🌐 Markdown | 📅 2026-08-21

## Contents

# A (3):

* [AnKi 3D Engine](https://github.com/godlikepanos/anki-3d-engine) ⭐ 1,610 | 🐛 12 | 🌐 C++ | 📅 2026-08-26 - Vulkan backend, modern renderer, scripting, physics and more
...
* [Bonsai](https://github.com/scallyw4g/bonsai) ⭐ 1,252 | 🐛 27 | 🌐 C | 📅 2026-08-14 - Bonsai is a 3D voxel-based engine built with the intention of writing both fast-paced arcade games and tile/turn-based RPGs.
...
* [Crown](https://github.com/crownengine/crown) ⭐ 2,437 | 🐛 46 | 🌐 C++ | 📅 2026-08-27 - Crown is a general purpose and data-driven 3D and 2D game engine, written in orthodox C++ with a minimalistic and data-oriented design philosophy in mind.
* [Codename One](https://github.com/codenameone/CodenameOne) ⭐ 1,860 | 🐛 271 | 🌐 Java | 📅 2026-08-27 - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
...
* [Dagor](https://github.com/GaijinEntertainment/DagorEngine) ⭐ 2,954 | 🐛 75 | 🌐 C++ | 📅 2026-08-16 - Formerly closed source 3D game engine made and mostly used by Gajin Entertainment.
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 13,421 | 🐛 268 | 🌐 Go | 📅 2026-08-26 - Ebitengine (formerly known as Ebiten) is an open source game engine for the Go programming language. Ebitengine's simple API allows you to quickly and easily develop 2D games that can be deployed across multiple platforms.
* [ezEngine](https://github.com/ezEngine/ezEngine) ⭐ 2,000 | 🐛 36 | 🌐 C++ | 📅 2026-08-27 - ezEngine is a free, open source game engine written in C++. Its philosophy is to be modular and flexible, such that it can be adapted to many different use cases. EZ utilizes a plugin system to integrate features such as FMOD or Jolt Physics. This makes it possible to only include those features that you need, or to replace systems with a custom solution that works better for your requirements. Similarly, the EZ code base can be built in multiple tiers, where you either get the entire feature set, with a fully functional editor, asset management and renderer, or you can strip it down to just the base libraries and core engine functionality. This can be extremely useful if you need to build a lot of custom technology, but require a high-performance, reliable foundation. EZ has a strong emphasis on providing robust, easy to use and well-tested base functionality. It is successfully being used in such a capacity in commercial products.
...
* [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,528 | 🐛 59 | 🌐 Rust | 📅 2026-08-23 - A feature-rich, production-ready, general purpose 2D/3D game engine written in Rust with a scene editor. Formerly known as rg3d.
...
* [Godot](https://github.com/godotengine/godot) ⭐ 116,217 | 🐛 18,769 | 🌐 C++ | 📅 2026-08-27 - Godot Engine is a feature-packed, cross-platform game engine to create 2D and 3D games from a unified interface. It provides a comprehensive set of common tools, so that users can focus on making games without having to reinvent the wheel. Games can be exported with one click to a number of platforms, including the major desktop platforms (Linux, macOS, Windows), mobile platforms (Android, iOS), as well as Web-based platforms and consoles.
...
* [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,869 | 🐛 35 | 🌐 C++ | 📅 2026-08-26 - 3D C++ Game Engine - yet another open source game engine.
...
* [Limitless Engine](https://github.com/hotstreams/limitless-engine) ⭐ 635 | 🐛 9 | 🌐 C++ | 📅 2026-08-21 - Limitless Engine is a 3D graphics engine, focused on high-performance, low-overhead rendering with modern OpenGL & C++17.
...
* [Mach Engine](https://github.com/hexops/mach) ⭐ 4,829 | 🐛 167 | 🌐 Zig | 📅 2026-05-23 - Zig game engine & graphics toolkit for building high-performance, truly cross-platform, robust & modular games, visualizations, and desktop/mobile GUI apps.
...
* [Nebula](https://github.com/gscept/nebula) ⭐ 1,092 | 🐛 34 | 🌐 C++ | 📅 2026-08-25 - Nebula is an open-source and free-to-use modern C++ game engine.
...
* [Overload](https://github.com/Overload-Technologies/Overload) ⭐ 2,467 | 🐛 88 | 🌐 C++ | 📅 2026-08-25 - Overload is a free, open-source 3D game engine made in C++ with Lua as its scripting language.
...
* [3DWorld](https://github.com/fegennari/3DWorld) ⭐ 1,414 | 🐛 0 | 🌐 C++ | 📅 2026-08-27 - 3DWorld is a cross-platform OpenGL-based 3D Game Engine created after the CS184 computer graphics course at UC Berkeley in 2001.
...
* [Traktor](https://github.com/apistol78/traktor) ⭐ 561 | 🐛 8 | 🌐 C++ | 📅 2026-08-27 - Traktor is an open-source 3d game engine written in C++, it has powered several successful commercial titles across various platforms including Steam, PSN, iOS, and the Mac Store.
...
* [U3D](https://github.com/u3d-community/U3D) ⭐ 424 | 🐛 20 | 🌐 C++ | 📅 2026-08-26 - U3D is a open source, lightweight, cross-platform 2D and 3D game engine implemented in C++. Forked from Urho3D and greatly inspired by OGRE and Horde3D.
...
* [Graphic Engine & Game Engine open source list](https://github.com/Gforcex/OpenGraphic) ⭐ 2,274 | 🐛 3 | 📅 2026-07-09
* [Game Engines with Source](https://github.com/redorav/public_source_engines) ⭐ 765 | 🐛 2 | 📅 2026-08-23
