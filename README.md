...
* [AnKi 3D Engine](https://github.com/godlikepanos/anki-3d-engine) ⭐ 1,610 | 🐛 12 | 🌐 C++ | 📅 2026-08-27 - Vulkan backend, modern renderer, scripting, physics and more
...
* [Crown](https://github.com/crownengine/crown) ⭐ 2,438 | 🐛 46 | 🌐 C++ | 📅 2026-08-27 - Crown is a general purpose and data-driven 3D and 2D game engine, written in orthodox C++ with a minimalistic and data-oriented design philosophy in mind.
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 13,426 | 🐛 273 | 🌐 Go | 📅 2026-08-27 - Ebitengine (formerly known as Ebiten) is an open source game engine for the Go programming language. Ebitengine's simple API allows you to quickly and easily develop 2D games that can be deployed across multiple platforms.
...
* [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,529 | 🐛 59 | 🌐 Rust | 📅 2026-08-27 - A feature-rich, production-ready, general purpose 2D/3D game engine written in Rust with a scene editor. Formerly known as rg3d.
...
* [LumixEngine](https://github.com/nem0/LumixEngine) ⭐ 3,870 | 🐛 35 | 🌐 C++ | 📅 2026-08-26 - 3D C++ Game Engine - yet another open source game engine.
...
* [Overload](https://github.com/Overload-Technologies/Overload) ⭐ 2,468 | 🐛 90 | 🌐 C++ | 📅 2026-08-25 - Overload is a free, open-source 3D game engine made in C++ with Lua as its scripting language.
...
* [Traktor](https://github.com/apistol78/traktor) ⭐ 562 | 🐛 8 | 🌐 C++ | 📅 2026-08-27 - Traktor is an open-source 3d game engine written in C++, it has powered several successful commercial titles across various platforms including Steam, PSN, iOS, and the Mac Store.
...
* [Game Engines with Source](https://github.com/redorav/public_source_engines) ⭐ 766 | 🐛 2 | 📅 2026-08-23
