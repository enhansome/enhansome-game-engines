...
* [AnKi 3D Engine](https://github.com/godlikepanos/anki-3d-engine) ⭐ 1,602 | 🐛 12 | 🌐 C++ | 📅 2026-08-13 - Vulkan backend, modern renderer, scripting, physics and more
...
* [Crown](https://github.com/crownengine/crown) ⭐ 2,425 | 🐛 47 | 🌐 C++ | 📅 2026-08-13 - Crown is a general purpose and data-driven 3D and 2D game engine, written in orthodox C++ with a minimalistic and data-oriented design philosophy in mind.
...
* [DummyEngine](https://github.com/sergcpp/DummyEngine) ⭐ 412 | 🐛 1 | 🌐 C++ | 📅 2026-08-11 - Сross-platform Vulkan/OpenGL 3D engine for personal experimentation
...
* [Ebitengine](https://github.com/hajimehoshi/ebiten) ⭐ 13,397 | 🐛 294 | 🌐 Go | 📅 2026-08-13 - Ebitengine (formerly known as Ebiten) is an open source game engine for the Go programming language. Ebitengine's simple API allows you to quickly and easily develop 2D games that can be deployed across multiple platforms.
...
* [Fyrox](https://github.com/FyroxEngine/Fyrox) ⭐ 9,502 | 🐛 60 | 🌐 Rust | 📅 2026-08-13 - A feature-rich, production-ready, general purpose 2D/3D game engine written in Rust with a scene editor. Formerly known as rg3d.
...
* [Limon](https://github.com/enginmanap/limonEngine) ⭐ 703 | 🐛 48 | 🌐 C++ | 📅 2026-08-11 - Limon is a multi platform 3D game engine mainly focusing on first person games. Focus of its development is ease of use and ease of study.
...
* [Mach Engine](https://github.com/hexops/mach) ⭐ 4,819 | 🐛 167 | 🌐 Zig | 📅 2026-05-23 - Zig game engine & graphics toolkit for building high-performance, truly cross-platform, robust & modular games, visualizations, and desktop/mobile GUI apps.
...
* [3DWorld](https://github.com/fegennari/3DWorld) ⭐ 1,411 | 🐛 0 | 🌐 C++ | 📅 2026-08-13 - 3DWorld is a cross-platform OpenGL-based 3D Game Engine created after the CS184 computer graphics course at UC Berkeley in 2001.
...
* [Traktor](https://github.com/apistol78/traktor) ⭐ 553 | 🐛 8 | 🌐 C++ | 📅 2026-08-13 - Traktor is an open-source 3d game engine written in C++, it has powered several successful commercial titles across various platforms including Steam, PSN, iOS, and the Mac Store.
